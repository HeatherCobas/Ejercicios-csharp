    ...
    public partial class FrmUsuarios: Form
    {
        ...
        private void dgvUsuarios_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    var rolSeleccionado = rolBLL.ObtenerRoles().FirstOrDefault(r => r.NombreRol == rolUsuario);

                    if (rolSeleccionado != null)
                    {
                        cmbRoles.SelectedItem = rolSeleccionado;
                    }
                }
            }
        }
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            //El usuario de soporte no puede agregar usuarios 
            LimpiarFormulario();
            txtUsuario.Focus();

            var rolPorDefecto = rolBLL.ObtenerRoles().FirstOrDefault(r => r.NombreRol == "Usuario");
            if (rolPorDefecto != null)
                cmbRoles.SelectedItem = rolPorDefecto;
        }
        ...
        {
            //El usuario de soporte no puede eliminar usuarios
        ...
        {
            Rol rolSeleccionado = cmbRoles.SelectedItem as Rol;
            if (rolSeleccionado == null)
            {
